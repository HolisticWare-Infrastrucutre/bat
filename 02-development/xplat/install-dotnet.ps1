...
@(
    ...
    [pscustomobject]
    @{
        #url='https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/sdk-3.1.417-windows-x64-installer';
        url='https://download.visualstudio.microsoft.com/download/pr/962fa33f-e57c-4e8a-abc9-01882ff74e3d/23e11ee6c3da863fa1489f951aa7e75e/dotnet-sdk-3.1.417-win-x64.exe';
        file='sdk-3.1.417-windows-x64-installer.exe'
    },
    [pscustomobject]
    @{
        #url='https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-aspnetcore-3.1.23-windows-x64-installer';
        url='https://download.visualstudio.microsoft.com/download/pr/0de950c1-b385-438a-b1be-9f4fc0c35be5/4aa21f95334bf59d842cd899763ff6e1/aspnetcore-runtime-3.1.23-win-x64.exe';
        file='runtime-aspnetcore-3.1.23-windows-x64-installer.exe'
    },
    [pscustomobject]
    @{
        #url='https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-3.1.23-windows-x64-installer';
        ...
        file='runtime-desktop-3.1.23-windows-x64-installer.exe'
    },
    [pscustomobject]
    @{
        #url='https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-3.1.23-windows-x64-installer';
        url='https://download.visualstudio.microsoft.com/download/pr/9fa03f97-6c46-4aa1-8193-00a5b66dfae8/1638ae61aeb362ecf63ce4142a188d89/dotnet-runtime-3.1.23-win-x64.exe';
        file='runtime-3.1.23-windows-x64-installer.exe'
    },
    #----------------------------------------------------------------------------------------------------------------------------------
    [pscustomobject]
    @{
