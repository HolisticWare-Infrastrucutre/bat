...
string[] projects_dotnet = new[]
{
    ...
    reference \
        add \
            ...
            --project source/user-interface-ui/HolisticWare.Core.UserInterfaceUI \
    """,
    """
    new \
        mauilib \
    ...
    reference \
        add \
            ...
            --project source/user-interface-ui/HolisticWare.Core.UserInterfaceUI.MAUI \
    """,
    """
    new \
        razorclasslib \
    ...
    reference \
        add \
            source/user-interface-ui/HolisticWare.Core.UserInterfaceUI/ \
            --project source/user-interface-ui/HolisticWare.Core.UserInterfaceUI.Razor \
    """,
    """
    new \
        classlib \
            --output source/utilities/HolisticWare.Utilities \
    """,
    """
    reference \
        add \
            source/business-domain-logic-models/HolisticWare.Core.BusinessDomainLogicModels \
            --project source/utilities/HolisticWare.Utilities \
    """,
    """
    new \
        sln \
    ...
    new \
        console \
        --output samples/clients/AppConsole.SampleDemo \
    """,
};
                                        ...
                                        files = new[]
{
    ...
    (
        ...
        <Project>
            ...
            <PropertyGroup>
                <UsePackageReferenceModeForSamplesAndTests>true</UsePackageReferenceModeForSamplesAndTests>
            </PropertyGroup>
    ...
    (
        "tests/unit-tests/Directory.Build.props",
        """
        <Project>
            <Import Project="..\Directory.Build.props" />            
        </Project>
    ...
    (
        "tests/benchmark-tests/Directory.Build.props",
        """
        <Project>
            <Import Project="..\Directory.Build.props" />            
        </Project>
    ...
    (
        "source/Directory.Packages.props.txt",
        """
        <Project>
        </Project>
        """,
...
foreach ((string file, string content, string url) t in files)
{
    ...
    if (string.IsNullOrEmpty(t.content) && !string.IsNullOrEmpty(t.url))
    {
        ...
        file_content = http_client.GetStringAsync(t.url).Result;
    }
